...
export const Navbar: React.FC = () => {
  ...
  return (
    <>
            ...
            <Link to="/" className="flex items-center gap-2 group">
              ...
              <div className="leading-tight">
                ...
                <span className="text-[9px] sm:text-[10px] text-zinc-500 font-bold tracking-wide uppercase flex items-center gap-0.5 font-mono">
                  <MapPin className="w-3 h-3 text-orange-500 shrink-0" /> Kungsträdgården
                </span>
              </div>
            </Link>
      ...
      {/* Mobile Bottom Navigation Bar (Sticky & Native Mobile App Experience) */}
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-zinc-200 px-2 py-1.5 flex justify-around items-center shadow-lg">
        <Link
          to="/"
          className={`flex flex-col items-center justify-center gap-1 px-3 py-1.5 rounded-xl transition-all cursor-pointer min-h-[48px] min-w-[64px] ${
            isActive("/")
        ...
        >
          ...
          <span className="text-[10px]">Attendee</span>
        </Link>
